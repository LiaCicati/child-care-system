...
public class RegisterBabysitterViewModel
{
    ...
    public boolean registerWithRequiredData() throws RemoteException
    {
        ...
        {
            model
                .registerBabysitter(username.get(), password.get(), email.get(),
    ...
    public boolean register() throws RemoteException
    {
        try
        {
            model
                .registerBabysitter(username.get(), password.get(), email.get(),
                    firstName.get(), lastName.getValue(), age.get(),
                    paymentPerHour.get(), motherTongue.get(),
                    babysittingExperience.get(), hasCertificate.get());
            errorLabel.set("");
            return true;
        }
        catch (Exception e)
